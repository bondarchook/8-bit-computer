...
class MicrocodeRomBuilderTests(unittest.TestCase):
    ...
    def test_setValue0(self):
        ...
        address = self._address_calculator.calculate_address(0, 0, 0)
        self.assertEqual(builder.data[address], 42)
